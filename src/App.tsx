...
export default function App() {
  ...
  const subjects = courseObj?.olevelSubjects ?? [
    "Subject 1",
    "Subject 2",
    "Subject 3",
    "Subject 4",
        ...
        <header className="bg-white border-b border-gray-100 sticky top-0 z-20 shadow-sm">
          <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400">2026/2027 Admission</p>
            </div>
          ...
          <div className="max-w-lg mx-auto px-4 pt-5 pb-4 space-y-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 flex gap-2">
              ...
              <p className="text-xs text-amber-800 leading-relaxed">
                <span className="font-bold">PROTECT YOURSELF:</span> LAUTECH
                admission cannot be bought. Do not give money to anyone
                promising you admission.
              </p>
            </div>
                ...
                <div className="flex gap-1.5">
                  {[0, 1, 2, 3].map((i) => (
                    <div
                      ...
                      style={{
                        backgroundColor: i <= step ? "#CC1B1B" : "#e5e7eb",
                      }}
                    />
                  ))}
                </div>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div className="grid grid-cols-3 gap-2 mt-4">
                          {(["science", "commercial", "art"] as Field[]).map(
                            (f) => (
                              <button
                                key={f}
                                onClick={() => {
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-4">
                          {[
                            ...
                            <button
                              ...
                              onClick={() =>
                                setIndigene(
                                  opt.value as "indigene" | "nonIndigene",
                                )
                              }
